...
<aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link text-decoration-none" href="{{ route('dashboard.index') }}">
      ...
      <li class="nav-item">
        ...
        <ul id="notes-nav" class="nav-content collapse" data-bs-parent="#sidebar-nav">
          ...
          <li>
            <a href="{{ route('note.create') }}" class="text-decoration-none">
              <i class="fas fa-plus"></i><span>&nbsp;Nouvelle Note</span>
            </a>
          </li>
          <li>
            <a href="{{ route('get.cards') }}" class="text-decoration-none">
      ...
      <li class="nav-item">
        ...
        <ul id="settings-nav" class="nav-content collapse" data-bs-parent="#sidebar-nav">
          ...
          <li>
            <a href="{{ route('ratio.create') }}" class="text-decoration-none">
